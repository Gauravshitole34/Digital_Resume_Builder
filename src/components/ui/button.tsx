  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-card hover:bg-gradient-card hover:shadow-medium hover:scale-105",
        secondary:
          "bg-gradient-secondary text-secondary-foreground hover:scale-105 hover:shadow-medium",
        accent:
          "bg-gradient-accent text-accent-foreground hover:scale-105 hover:shadow-medium",
        ghost: "hover:bg-muted hover:scale-105 transition-smooth",
        link: "text-primary underline-offset-4 hover:underline hover:text-primary-light",
        wizard: "bg-gradient-primary text-primary-foreground hover:bg-primary-dark hover:scale-105 hover:shadow-glow shadow-soft",
        floating: "bg-gradient-primary text-primary-foreground hover:scale-110 hover:shadow-glow shadow-large rounded-full",
      },
      size: {
